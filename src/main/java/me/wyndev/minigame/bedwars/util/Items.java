package me.wyndev.minigame.bedwars.util;
...
public class Items {
    ...
    public static ItemStack MENU_FIREBALL = createItem("Fireball", "FIREBALL", Material.FIRE_CHARGE, false, false, List.of(), new HashMap<>());
    ...
    private static ItemStack createItem(String displayName, String id, Material type, boolean noMove, boolean noDrop, List<Integer> allowedSlots, Map<RegistryKey<Enchantment>, Integer> enchants, String... lore) {
        ...
        for (String s : lore) list.add(Main.MINI_MESSAGE.deserialize(s));
        EnchantmentList enchantmentList = new EnchantmentList(enchants);
        ItemStack.Builder builder = ItemStack.builder(type);
        builder.set(DataComponents.ITEM_NAME, Main.MINI_MESSAGE.deserialize(displayName));
    ...
    private static ItemStack createArmor(String name, String id, Material type, NamedTextColor color) {
        ItemStack.Builder builder = ItemStack.builder(type);
        builder.set(DataComponents.ITEM_NAME, Main.MINI_MESSAGE.deserialize(name));
        builder.set(DataComponents.UNBREAKABLE);
        builder.set(DataComponents.TOOLTIP_DISPLAY, new TooltipDisplay(false, Set.of(DataComponents.EQUIPPABLE, DataComponents.UNBREAKABLE)));
